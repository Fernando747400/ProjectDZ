...
void CalculateMainLight_float(float3 WorldPos,out float3 Direction,
    out float3 Color, out half DistanceAtten, out half ShadowAtten)
{
...
/* void AddAdditionalLights_float(float Smoothness, float3 WorldPosition, float3 WorldView,
